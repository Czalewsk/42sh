...
const t_classic g_classics[] = {
	...
	{AND, GREAT, &go_to_current_left, NULL},
	{AND, LESS, &go_to_current_left, NULL},
	{AND, DGREAT, &go_to_current_left, NULL},
	{AND, DLESS, &go_to_current_left, NULL},
	{AND_IF, WORD, &go_to_current_right, NULL},
	{AND_IF, SUBSH, &go_to_current_right, NULL},
	{AND_IF, IO_NUMBER, &go_to_current_right, NULL},
	{AND_IF, GREAT, &go_to_current_right, NULL},
	{AND_IF, LESS, &go_to_current_right, NULL},
	{AND_IF, DGREAT, &go_to_current_right, NULL},
	{AND_IF, DLESS, &go_to_current_right, NULL},
	...
	{OR_IF, GREAT, &go_to_current_right, NULL},
	{OR_IF, LESS, &go_to_current_right, NULL},
	{OR_IF, DGREAT, &go_to_current_right, NULL},
	{OR_IF, DLESS, &go_to_current_right, NULL},
	...
	{PIPE, LESS, &go_to_current_right, NULL},
	{PIPE, DLESS, &go_to_current_right, NULL},
	{PIPE, GREAT, &go_to_current_right, NULL},
	{PIPE, DGREAT, &go_to_current_right, NULL},
	...
	{SEMI, GREAT, &go_to_current_left, NULL},
	{SEMI, LESS, &go_to_current_left, NULL},
	{SEMI, DGREAT, &go_to_current_left, NULL},
	{SEMI, DLESS, &go_to_current_left, NULL},
