...
/*   Updated: 2017/12/05 21:53:47 by czalewsk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern inline void	set_escape(char *str, unsigned int index)
{
	*(str + index / 8) |= (1 << (index % 8));
}

extern inline char	sh_is_escape(char *str, unsigned int index)
{
